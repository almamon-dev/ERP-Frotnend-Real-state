...
export default function CalendarEventsWidget() {
  ...
  return (
    <div className="bg-white p-4 rounded-md border border-slate-200/90 shadow-2xs flex flex-col mb-3">
      ...
      <button
        onClick={() => navigate('/administration/dashboard/calendar')}
        className="w-full py-2 rounded-md bg-slate-50 hover:bg-slate-100 text-[11px] font-bold text-slate-600 transition-colors cursor-pointer border border-slate-200/80"
      >
        View Full Calendar
      </button>
    </div>
