...
import { projectProgressData } from '../../constants/dashboardData';
...
export default function ProjectProgressChart() {
  return (
    <div className="bg-white p-4 rounded-md border border-slate-200/90 shadow-2xs flex flex-col h-[200px]">
      <h3 className="text-[13px] font-bold text-slate-900 mb-2">Project Progress</h3>
      ...
      <div className="flex items-center justify-between flex-1 gap-2">
        <div className="relative h-[130px] w-[130px] shrink-0 flex items-center justify-center">
          ...
          <div className="absolute text-center">
            <span className="text-[13px] font-black text-slate-900 block leading-none">58</span>
