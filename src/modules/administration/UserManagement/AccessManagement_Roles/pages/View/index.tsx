...
import { Activity, ArrowLeft, ChevronRight, FileText, Info, Key, Layout, Save, Shield } from 'lucide-react';
...
const TABS = [
    { id: 'overview', label: 'Role Overview', icon: Shield },
    { id: 'basic', label: 'Basic Information', icon: Info },
    { id: 'permissions', label: 'Permissions', icon: Key },
    { id: 'module', label: 'Module Access', icon: Layout },
        ...
        <div className="p-6 md:p-8 mx-auto bg-[#f8f9fa] min-h-screen pb-24">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                    <div>
                        <h1 className="text-[22px] font-bold text-slate-900">View Role</h1>
                        <p className="text-[14px] font-medium text-[#008060] mt-1">Fill in the required information to view a role.</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex-1 bg-white border border-slate-200 rounded-md shadow-sm w-full">
                    <div className="p-6 md:p-8">
                        ...
                        {activeTab === 'overview' && (
                            <div className="space-y-3 animate-in fade-in duration-300">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 w-full">
                                    <TabHeader title="Role Overview" icon={Shield} />
                        ...
                        {activeTab === 'permissions' && (
                            <div className="space-y-3 animate-in fade-in duration-300">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 w-full">
                                    <TabHeader title="Permissions" icon={Key} />
                        ...
                        {activeTab === 'module' && (
                            <div className="space-y-3 animate-in fade-in duration-300">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 w-full">
                                    <TabHeader title="Module Access" icon={Layout} />
