            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                    <div>
                        ...
                        <p className="text-[14px] font-medium text-[#008060] mt-1">Fill in the required information to add a new company.</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                                    ...
                                    <div className="col-span-1 md:col-span-2 mb-2 grid grid-cols-[160px_10px_1fr] items-start gap-3">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <Button variant="outline" size="sm" className="h-[28px] text-[13px] font-semibold">Upload Logo</Button>
